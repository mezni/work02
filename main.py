...
import random
import datetime
r = redis.StrictRedis(host='172.19.0.2', port=6379, password='eYVX7EwVmmxKPCDmwMtyKVge8oLd2t81', decode_responses=True)
...
interval_min_ts = int(datetime.datetime.strptime("24/10/2023 21:00:00", "%d/%m/%Y %H:%M:%S").timestamp())
interval_max_ts = int(datetime.datetime.strptime("24/10/2023 21:05:00", "%d/%m/%Y %H:%M:%S").timestamp())
