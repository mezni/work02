...
use crate::domain::events::network_events::{NetworkCreated, NetworkEvent, NetworkVerified};
...
impl Network {
    pub fn new(
        ...
        network
            .events
            .push(NetworkEvent::NetworkCreated(NetworkCreated {
                network_id,
                name,
                network_type,
                created_by,
    ...
    pub fn verify(&mut self, verified_by: Uuid) -> Result<(), String> {
        ...
        self.events
            .push(NetworkEvent::NetworkVerified(NetworkVerified {
