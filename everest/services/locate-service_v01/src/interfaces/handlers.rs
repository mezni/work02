...
use crate::infrastructure::{DomainError, StationRepository, ReviewRepository};
...
pub async fn find_nearby_stations(
    ...
    let station_repo = Arc::new(StationRepository::new(pool.get_ref().clone()));
...
pub async fn create_review(
    ...
    let review_repo = Arc::new(ReviewRepository::new(pool.get_ref().clone()));
