...
pub async fn start_server(config: Config) -> anyhow::Result<()> {
    ...
    tracing::info!("Swagger UI available at http://{}:{}/swagger-ui/", server_host, server_port);
...
mod tests {
    ...
    async fn test_app_state_creation() {
        std::env::set_var("DATABASE_URL", "postgresql://postgres:password@localhost:6200/test_db");
